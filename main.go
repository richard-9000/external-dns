...
import (
	...
	"github.com/richard-9000/external-dns/controller"
	"github.com/richard-9000/external-dns/endpoint"
	"github.com/richard-9000/external-dns/pkg/apis/externaldns"
	"github.com/richard-9000/external-dns/pkg/apis/externaldns/validation"
	"github.com/richard-9000/external-dns/plan"
	"github.com/richard-9000/external-dns/provider"
	"github.com/richard-9000/external-dns/provider/akamai"
	"github.com/richard-9000/external-dns/provider/alibabacloud"
	"github.com/richard-9000/external-dns/provider/aws"
	"github.com/richard-9000/external-dns/provider/awssd"
	"github.com/richard-9000/external-dns/provider/azure"
	"github.com/richard-9000/external-dns/provider/bluecat"
	"github.com/richard-9000/external-dns/provider/cloudflare"
	"github.com/richard-9000/external-dns/provider/coredns"
	"github.com/richard-9000/external-dns/provider/designate"
	"github.com/richard-9000/external-dns/provider/digitalocean"
	"github.com/richard-9000/external-dns/provider/dnsimple"
	"github.com/richard-9000/external-dns/provider/dyn"
	"github.com/richard-9000/external-dns/provider/exoscale"
	"github.com/richard-9000/external-dns/provider/gandi"
	"github.com/richard-9000/external-dns/provider/godaddy"
	"github.com/richard-9000/external-dns/provider/google"
	"github.com/richard-9000/external-dns/provider/hetzner"
	"github.com/richard-9000/external-dns/provider/infoblox"
	"github.com/richard-9000/external-dns/provider/inmemory"
	"github.com/richard-9000/external-dns/provider/linode"
	"github.com/richard-9000/external-dns/provider/ns1"
	"github.com/richard-9000/external-dns/provider/oci"
	"github.com/richard-9000/external-dns/provider/ovh"
	"github.com/richard-9000/external-dns/provider/opensensebind"
	"github.com/richard-9000/external-dns/provider/pdns"
	"github.com/richard-9000/external-dns/provider/rcode0"
	"github.com/richard-9000/external-dns/provider/rdns"
	"github.com/richard-9000/external-dns/provider/rfc2136"
	"github.com/richard-9000/external-dns/provider/scaleway"
	"github.com/richard-9000/external-dns/provider/transip"
	"github.com/richard-9000/external-dns/provider/ultradns"
	"github.com/richard-9000/external-dns/provider/vinyldns"
	"github.com/richard-9000/external-dns/provider/vultr"
	"github.com/richard-9000/external-dns/registry"
	"github.com/richard-9000/external-dns/source"
)
...
func main() {
	...
	case "opensensebind":
		p, err = opensensebind.NewOSBProvider(ctx, domainFilter, cfg.OSBEndpoint, cfg.OSBApiRateLimit, cfg.DryRun)
	case "linode":
